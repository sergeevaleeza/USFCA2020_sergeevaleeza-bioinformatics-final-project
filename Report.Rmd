...
``` {r total-deaths-plot, fig.height=6}
...
``` {r total-hospital-plot, fig.height=6}
...
``` {r total-positive-plot, fig.height=6}
...
``` {r increase-death-positive-test-plots, fig.height=10}
# take previously
all_state_data <- all_state_covid_data()
...
``` {r population-and-density-plot, fig.height=8}
