...
then
  ...
  echo "The sixs should be the path to population data csv file"
  exit 1
fi

# Set input params for the render command
RMD_FILE="$1"
RMD_PARAMS="params = list(gff_file_path = '$2', vcf_dir_path = '$3', sra_runtable_path = '$4', chosen_date = '$5', pop_density_data = '$6')"
